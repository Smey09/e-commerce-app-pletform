...
import '../../../../../Data/chat/gruop_data.dart';

class main_group_chat extends StatefulWidget {
  const main_group_chat({super.key});

  @override
  State<main_group_chat> createState() => _main_gemeralState();
}

class _main_gemeralState extends State<main_group_chat> {
  @override
