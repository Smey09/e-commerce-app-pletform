...
import '../../../../../../Service/Detail_Page/Phone/Samsung.dart';
import '../../../../Data/Phone/Samsung_data.dart';

class buildScreen_SamsungProduct_List extends StatefulWidget {
  const buildScreen_SamsungProduct_List({super.key});

  @override
  State<buildScreen_SamsungProduct_List> createState() =>
      _buildScreen_SamsungProduct_ListState();
}

class _buildScreen_SamsungProduct_ListState
    extends State<buildScreen_SamsungProduct_List> {
  @override
      ...
      child: Column(
        children: [
          ...
          Wrap(
            ...
            children: phones
                .map(
                  (SamsungProduct_Data phone) => GestureDetector(
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => SamsungDetailsPage(phone: phone),
                      ),
                    ), // Handle product tap
                    child: Container(
                      height: 160,
