...
class buildScreen_Apple_Watch_Product_List extends StatefulWidget {
  ...
  @override
  State<buildScreen_Apple_Watch_Product_List> createState() =>
      _buildScreen_Asus_Monirtor_Product_ListState();
}

class _buildScreen_Asus_Monirtor_Product_ListState
    extends State<buildScreen_Apple_Watch_Product_List> {
  @override
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  appleWatches.condition,
                                  style: TextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.w700,
                                    color: appleWatches.condition == "New"
                                        ? Colors.green
                                        : Colors.pink,
                                  ),
                                ),
                          ...
                          // Image.asset(
                          //   appleWatches.imageUrl,
                          //   width: 200.0,
                          //   height: 100.0,
                          // ),
                          appleWatches.imageUrl.isNotEmpty
                              ? Image.asset(
                                  appleWatches.imageUrl,
                                  width: 200.0,
                                  height: 100.0,
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      appleWatches.price.toStringAsFixed(2),
                                      style: const TextStyle(
                                        fontSize: 13,
                                        fontWeight: FontWeight.w700,
                                        color: Colors.black,
