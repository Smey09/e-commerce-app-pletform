...
import '../../../../../../Service/Detail_Page/TV/Samsung.dart';
...
class buildScreen_Samsung_TV_Product_List extends StatefulWidget {
  ...
  @override
  State<buildScreen_Samsung_TV_Product_List> createState() =>
      _buildScreen_Asus_Monirtor_Product_ListState();
}

class _buildScreen_Asus_Monirtor_Product_ListState
    extends State<buildScreen_Samsung_TV_Product_List> {
  @override
            ...
            children: SamsungTVs.map(
              (SamsungTVProduct_Data SamsungTVs) => GestureDetector(
                onTap: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        Samsung_TV_DetailsPage(SamsungTVs: SamsungTVs),
                  ),
                ),
                child: Container(
                  height: 160,
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              SamsungTVs.condition,
                              style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.w700,
                                color: SamsungTVs.condition == "New"
                                    ? Colors.green
                                    : Colors.pink,
                              ),
                            ),
                      ...
                      //   // fit: BoxFit.cover,
                      // ),
                      SamsungTVs.imageUrl.isNotEmpty
                          ? Image.asset(
                              SamsungTVs.imageUrl,
                              width: 200.0,
                              height: 100.0,
                              errorBuilder: (context, error, stackTrace) =>
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(25),
                                  color:
                                      const Color.fromARGB(255, 241, 251, 255),
                                ),
                                child: const Padding(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  SamsungTVs.price.toStringAsFixed(2),
                                  style: const TextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.w700,
                                    color: Colors.black,
